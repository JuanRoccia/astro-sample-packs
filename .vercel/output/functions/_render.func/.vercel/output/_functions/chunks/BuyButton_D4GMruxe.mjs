import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, b as createAstro } from './astro/server_CuTlcP9C.mjs';
import 'kleur/colors';
import 'clsx';
...
}, "C:/Users/juanm/OneDrive/Escritorio/Desarrollo Web 3.0/Astro Midudev Curso/ossified-osiris/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")} title="Comprar beat" target="_blank" rel="noopener noreferrer" class="text-balance inline-flex gap-2 items-center bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-600 text-black font-bold py-2 px-4 rounded-lg border borer-yellow-500 transition duration-200 ease-in-out hover:scale-105 justify-center text-center">
Comprar en ${countryName} ${renderComponent($$result, "AmazonLogo", $$AmazonLogo, {})} </a>`;
}, "C:/Users/juanm/OneDrive/Escritorio/Desarrollo Web 3.0/Astro Midudev Curso/ossified-osiris/src/components/BuyButton.astro", void 0);

const $$file = "C:/Users/juanm/OneDrive/Escritorio/Desarrollo Web 3.0/Astro Midudev Curso/ossified-osiris/src/components/BuyButton.astro";
const $$url = undefined;
